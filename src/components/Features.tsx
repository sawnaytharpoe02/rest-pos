...
import { Box, Typography, Zoom, Container } from "@mui/material";

const features = [
  {
    icon: <MenuBookIcon sx={{ fontSize: "60px", color: "#1B9C85" }} />,
    text: "Easily manage your menus with Foodie POS",
    delay: "1000ms",
  },
  {
    icon: <QrCode2Icon sx={{ fontSize: "60px", color: "#1B9C85" }} />,
    text: "Scan and order. Quick and easy! Your customers will love it!",
    delay: "1300ms",
  },
  {
    icon: <LocationOn sx={{ fontSize: "60px", color: "#1B9C85" }} />,
    text: "Foodie POS supports multiple locations for your business.",
    delay: "1500ms",
  },
  {
    icon: <ChecklistIcon sx={{ fontSize: "60px", color: "#1B9C85" }} />,
    text: "Backoffice and order apps are included in every subscription.",
    delay: "1700ms",
  },
  {
    icon: <SupportAgentIcon sx={{ fontSize: "60px", color: "#1B9C85" }} />,
